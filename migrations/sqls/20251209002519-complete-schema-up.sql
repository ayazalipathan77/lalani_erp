-- Complete Lalani ERP Schema Migration
-- This creates all tables with final schema including all migrations
...
-- Sales invoice items (with all final columns)
...
-- Expenses (without foreign key initially)
...
('T-1002', 'Sedan Comfort 195/65R15', 'CAR', 9500.00, 12000.00, 450, 50),
('TB-2001', 'Heavy Duty Tube 10.00-20', 'TUBE', 3000.00, 3500.00, 800, 100),
('T-1003', 'Off-Road Grip 265/70R17', 'SUV', 28000.00, 32000.00, 45, 10),
('T-1004', 'Tractor Rear 18.4-30', 'AGRI', 75000.00, 85000.00, 12, 5),
('T-1005', 'City Runner 175/70R13', 'CAR', 8000.00, 9500.00, 200, 30)
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
                   WHERE constraint_name = 'expenses_head_code_fkey'
