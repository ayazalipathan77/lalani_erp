...
export const mockProducts: Product[] = [
  { prod_id: 1, prod_code: 'T-1001', prod_name: 'Radial Truck Tire 295/80R22.5', category_code: 'TRUCK', cost_price: 35000, selling_price: 45000, current_stock: 120, min_stock_level: 20, tax_rate: 5 },
  { prod_id: 2, prod_code: 'T-1002', prod_name: 'Sedan Comfort 195/65R15', category_code: 'CAR', cost_price: 9000, selling_price: 12000, current_stock: 450, min_stock_level: 50, tax_rate: 5 },
  { prod_id: 3, prod_code: 'TB-2001', prod_name: 'Heavy Duty Tube 10.00-20', category_code: 'TUBE', cost_price: 2500, selling_price: 3500, current_stock: 800, min_stock_level: 100, tax_rate: 5 },
  { prod_id: 4, prod_code: 'T-1003', prod_name: 'Off-Road Grip 265/70R17', category_code: 'SUV', cost_price: 25000, selling_price: 32000, current_stock: 45, min_stock_level: 10, tax_rate: 5 },
  { prod_id: 5, prod_code: 'T-1004', prod_name: 'Tractor Rear 18.4-30', category_code: 'AGRI', cost_price: 70000, selling_price: 85000, current_stock: 12, min_stock_level: 5, tax_rate: 5 },
  { prod_id: 6, prod_code: 'T-1005', prod_name: 'City Runner 175/70R13', category_code: 'CAR', cost_price: 7000, selling_price: 9500, current_stock: 200, min_stock_level: 30, tax_rate: 5 },
];

export const mockCustomers: Customer[] = [
  { cust_id: 1, cust_code: 'C-001', cust_name: 'Karachi Auto Parts', city: 'Karachi', phone: '0300-1234567', outstanding_balance: 150000, credit_limit: 500000, discount_rate: 0, tax_rate: 0 },
  { cust_id: 2, cust_code: 'C-002', cust_name: 'Hyderabad Wheels', city: 'Hyderabad', phone: '0300-7654321', outstanding_balance: 0, credit_limit: 300000, discount_rate: 5, tax_rate: 0 },
  { cust_id: 3, cust_code: 'C-003', cust_name: 'Sukkur Transport Spares', city: 'Sukkur', phone: '0301-1122334', outstanding_balance: 75000, credit_limit: 200000, discount_rate: 0, tax_rate: 0 },
  { cust_id: 4, cust_code: 'C-004', cust_name: 'Larkana Tires', city: 'Larkana', phone: '0302-9988776', outstanding_balance: 250000, credit_limit: 250000, discount_rate: 10, tax_rate: 0 },
];
